...
enum IRIS_STATUS { irUNKNOWN = 0, irMANUAL, irDISABLED, irIDLE, irEVALUATING, irEVALUATING_TOO_DARK, irCLOSING, irCLOSED, irOPENING, irEND };
enum 
	{	AV1300 = 1300, AV1305 = 1305,
		...
		AV20185 = 20185, AV20365 = 20365,
		AV12186 = 12186, AV12366 = 12366,
		AV12176 = 12176, AV20175 = 20175,
		AV40185 = 40185, AV5185 = 5185

	};

enum AVCodecType {JPEG_CODEC = 0 , H264_CODEC = 1};
//---------------------------------------------------------------------------
enum CAMERA_PARAMETER{
   cpBRIGHTNESS, cpAUTO_EXPOSITION, cpSATURATION, cpSHARPNESS, cpBLUE, cpRED, cpILLUMINATION, cpLIGHTING, cpCAMERA_MODE,
   cpQUALITY_FULL, cpQUALITY_HALF, cpQUALITY_ZOOM, cpDOUBLESCAN, cpROLL,
   cpIRIS_ENABLED, cpIRIS_SPEED, cpIRIS_GAIN, /*cpIRIS_PEROSITION_ENABLED,*/ cpIRIS_REPOSITION_F_STOPS, cpIRIS_REPOSITION_F_STOPS_MIN, cpIRIS_REPOSITION_PERIOD, cpIRIS_REPOSITION_STABLE_PERIOD,
   cpDAY_NIGHT_MODE, cpDAY_NIGHT_TRIGGER_NIGHT, cpDAY_NIGHT_TRIGGER_DAY,
   ...
   cpSENSOR_BLACK_WHITE_LEFT, cpSENSOR_BLACK_WHITE_TOP, cpSENSOR_BLACK_WHITE_WIDTH, cpSENSOR_BLACK_WHITE_HEIGHT,
   cpREQUEST_LEFT, cpREQUEST_TOP, cpREQUEST_WIDTH, cpREQUEST_HEIGHT,
   cpQUALITY, cpRESOLUTION, cpPER_CENT_IMAGE_RECTANGLE, cpREQUESTED_BLOCK_SIZE,
   cpMD_ENABLED, cpMD_MODE, cpMD_LEVEL_THRESH, cpMD_TOTAL_ZONES, cpMD_ZONE_SIZE, cpMD_EXPLOSURE_SENSITIVITY, cpMD_MATRIX, cpMD_DETAIL,
   cpMS_NUMBER_OF_SENSOR, cpMS_CHANNEL_ENABLE, cpMS_FULL_RES_ENABLE, cpMS_ZOOM_WIN_ENABLE, cpMS_ONE_SHOT_ENABLE, cpMS_IS_ZOOMED, cpMS_QUAD_MODE,
